...
# Load the dataset
file_path <- 'C:\\Users\\RIDDHI\\OneDrive\\Desktop\\Bootcamp\\SCMA\\SCMA A3\\train.csv'
...
# Load the dataset
data_nss <- read.csv("C:\\Users\\RIDDHI\\OneDrive\\Desktop\\Bootcamp\\SCMA\\SCMA A3\\NSSO68.csv")
